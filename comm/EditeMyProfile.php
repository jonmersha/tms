...
<table width=80% id=tab1>
        <tr align=right>
            <td>
                <table >
                    <tr>
                        <td onclick=updateusersfullany('mainb','comm/saveprofilechange.php')><b><div id=button align=center><b>Save changes</b></div></b></td>
        ...
        <tr><td>
            ...
            <tr>
                <td width=30%>
                    <table width=100%>
                        <tr><td><b>User ID *</b><input type="text" id="uid" name='uid'value=<?php echo $row[0]?>></input></td></tr>
    ...
    <table>
                    <tr>
                        <td onclick=updateusersfullany('mainb','comm/saveprofilechange.php')><b><div id=button align=center><b>Save changes</b></div></td>
