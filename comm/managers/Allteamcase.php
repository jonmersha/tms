...
while($row=  mysqli_fetch_array($result)){
    ...
    $rownumber=  mysqli_num_rows($result1);
    ...
    . "<table><tr><td id=tdhl>$row[0] Team:$rownumber Total Cases <td>
        ...
        <table width=95%>
    <tr><td id='tdhl' ><div>Unassigned </div></td><td>".getCases($con,$row[0],'Not Assined')."</td></tr>
    <tr><td id='tdhl'>Assigned</td><td><p></p>".getCases($con,$row[0],'Assined')."</td></tr>
    <tr><td id='tdhl'>Resolved</td><td>".getCases($con,$row[0],'Resolved')."</td></tr>
    <tr><td id='tdhl'>Closed</td><td>".getCases($con,$row[0],'Closed')."</td></tr>
</table></td></tr></table>";
