function userv() {
  var status = "";
  if (intmail.value === "") {
    document.getElementById("intmailmess").innerHTML =
      "User internal mail is is empty";
    status = "x";
  }
  ...
  if (uname.value === "") {
    status = "x";
    document.getElementById("unamemess").innerHTML =
      "user id is mandatory field";
  }
  if (fname.value === "") {
  ...
  if (department.value === "") {
    document.getElementById("departmentmess").innerHTML =
      "User deparment is empty";
    status = "x";
  }
  if (ext.value === "") {
    document.getElementById("extmess").innerHTML = "Extention number is empty";
  ...
  if (oltmail.value === "") {
    document.getElementById("oltmailmess").innerHTML =
      "alternate mail  is empty";
    status = "x";
  }
  if (tele.value === "") {
    document.getElementById("telemess").innerHTML =
      "mobile number is empty name is empty";
    status = "x";
  }
  if (pass.value === "") {
...
function pp(str) {
  ...
  xhttp.open("GET", "menu/singelmenu.php", true);
  xhttp.send();
}
